...
export default function PerfilPage() {
  const { usuario: usuarioContext, atualizarUsuario, logout } = useAuth();
    ...
    <div className="mx-auto max-w-6xl space-y-8 pb-12">
      ...
      >
        ...
        <div className="relative px-6 pb-6 pt-0 sm:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 -mt-20">
            {/* AVATAR + INFOS */}
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-(--primary) px-4 py-2.5 text-sm font-medium text-(--primary-foreground) shadow-sm transition hover:bg-(--primary-hover) active:scale-[0.98] cursor-pointer"
              >
            ...
            <div className="rounded-3xl border border-(--card-border) bg-(--card) p-6 shadow-sm">
              ...
              <div className="mt-3 space-y-2">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 rounded-2xl bg-red-500/5 hover:bg-red-500/10 border border-red-500/10 transition text-xs font-medium text-red-500 cursor-pointer"
                >
